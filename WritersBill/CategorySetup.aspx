<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategorySetup.aspx.cs" Inherits="CategorySetup" %>
...
<body>
    ...
    <div style="position:absolute; height:650px;width:938px; margin-left:450px; margin-top:2px; background:#F0F6F8; border:2px solid #42839B;  border-radius: 10px; box-shadow: 5px 5px 5px #888888; top: 0px; left: -238px;">
        ...
        <div style="position:absolute; height:30px;width:928px; margin-left:0px; color:#071914; font-weight:bold; margin-top:0px; padding-left:10px; font-family:Verdana, Geneva, Sans Serif; background: -webkit-linear-gradient(#42839B, white);border-top-left-radius: 7px; border-top-right-radius: 7px;">Category Setup</div>
        ...
        <asp:Label ID="lblCategoryCode"  runat="server" CssClass="labelTextField" 
            Text="Category Code"  style="position:absolute; top:35px; left:10px;"  ></asp:Label>
        <asp:TextBox ID="txtCategoryCode" runat="server" autocomplete="off" CssClass="textBox" 
        ...
        <asp:Label ID="lblCategoryName"  runat="server" CssClass="labelTextField" 
            Text="Category Name"  style="position:absolute; top:35px; left:290px;"  ></asp:Label>
        <asp:TextBox ID="txtCategoryName" runat="server" autocomplete="off" 
            CssClass="textBox"  
...
<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" BorderColor="Gray" BorderWidth="1px" BorderStyle="Solid" Height="22px" Width="10px"></ItemStyle>
                        ...
                        <asp:BoundField DataField="CTCODE" SortExpression="CTCODE" ItemStyle-Font-Names="Verdana" 
                        ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle" ReadOnly="true"
                        ItemStyle-Width="10px" ItemStyle-Height="22px" ItemStyle-BorderStyle="Solid" 
                            ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gray">
...
<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" BorderColor="Gray" BorderWidth="1px" BorderStyle="Solid" Height="22px" Width="10px"></ItemStyle>
                        ...
                        <asp:BoundField DataField="CTNAME" SortExpression="CTNAME" ItemStyle-Font-Names="Verdana" 
                        ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle" ReadOnly="true" 
