...
public partial class LineageBillApprv : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlStatus.Items.Add("Submitted"); ddlStatus.Items.Add("Checked"); 
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        string strSelect = "Select * from View_LineageBill where   year='" + year + "' and Month='" + month + "' and status<>'Delete' and CREATEDBY='" + createdBy + "'  ";

        DataSet ds = new DataSet();
        ds = dataProvider.getDataSet(strSelect, "VIEWWRITERBILL");
        report.Load(Server.MapPath("Report\\WriterBill.rpt"));
        report.SetDataSource(ds);
        report.SetDatabaseLogon("sa", "erp", "192.168.10.105", "ALOCIR");
    ...
    protected void grdDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (ddlStatus.SelectedItem.Text == "Submitted")
            {
    ...
    {  
        ...
        txtApvLinePhoto.Text = ApvLine.Text;
        ...
        txtApvLinePhoto.Text = HttpUtility.HtmlDecode(grdDetails.Rows[rowIndex].Cells[10].Text);
        txtRate.Text = HttpUtility.HtmlDecode(grdDetails.Rows[rowIndex].Cells[9].Text);

        //txtPageNo.Text = HttpUtility.HtmlDecode(grdDetails.Rows[rowIndex].Cells[3].Text);
        string createdBy = this.Session["UserName"].ToString();
        string strUpdate = "UPDATE LINEAGEBILL SET APVAMOUNT=(" + txtRate.Text + ") * (" + ApvLine.Text + "),PGNO= '" + txtPageNo.Text + "' ,ANOLINEPHOT='" + ApvLine.Text + "' ,STATUS='Checked' where SL='" + txtHdnSL.Text + "' ";
        dataProvider.ExecuteCommand(strUpdate);
        loadData();
