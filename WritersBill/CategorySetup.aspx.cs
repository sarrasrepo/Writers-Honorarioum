...
public partial class CategorySetup : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string strInsert = "INSERT INTO LNCATEGORY VALUES('" + txtCategoryCode.Text + "','" + txtCategoryName.Text + "','" + DateTime.Now + "','" + createdBy + "','" + strStatus + "')";
    ...
    {
        string createdBy = this.Session["UserName"].ToString();
        string strUpdate = "UPDATE LNCATEGORY SET CTCODE='" + txtCategoryCode.Text + "',CTNAME='" + txtCategoryName.Text + "',CREATEDTAE='" + DateTime.Now + "',CREATEDBY='" + createdBy + "' where SL='" + txtSl.Text + "' ";
    ...
    private void loadData()
    {
        ...
        string strSelect = "select * from LNCATEGORY where STATUS=0 ";
    ...
    {
        txtCategoryCode.Text = HttpUtility.HtmlDecode(grdDetails.Rows[rowIndex].Cells[2].Text);
        txtCategoryName.Text = HttpUtility.HtmlDecode(grdDetails.Rows[rowIndex].Cells[3].Text);        
    ...
    {
        string strDelete = "Update LNCATEGORY set status='1' where SL='"+txtSl.Text+"'";
