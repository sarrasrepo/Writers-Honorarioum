<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LineageBillPost.aspx.cs" Inherits="LineageBillPost" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>::: Linage Bill :::</title>
...
<body>
    ...
    <div style="position:absolute; height:648px;width:911px; margin-left:300px; margin-top:2px; background:#F0F6F8; border:2px solid #42839B;  border-radius: 10px; box-shadow: 5px 5px 5px #888888; top: 0px; left: -95px;" 
        ...
        <div style="position:absolute; height:30px;width:900px; margin-left:0px; color:#071914; font-weight:bold; margin-top:0px; padding-left:10px; font-family:Verdana, Geneva, Sans Serif; background: -webkit-linear-gradient(#42839B, white);border-top-left-radius: 7px; border-top-right-radius: 7px;">LINEAGE BILL POST</div>
        ...
        <%--<asp:Button id="btnPrint" CssClass="Submitbutton" runat="server" Text="Print" 
            style="position:absolute; top:161px; left:1115px; height:30px; width:70px;" 
        ...
        <asp:Button id="btnPost" CssClass="Submitbutton" runat="server" Text="Post" 
            style="position:absolute; top:145px; left:475px; height:30px; width:70px;" 
...
<%--                        <asp:BoundField DataField="TRANSDATE" SortExpression="TRANSDATE" ItemStyle-Font-Names="Verdana" DataFormatString="{0:dd-MMM-yy}"
...
<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" BorderColor="Gray" BorderWidth="1px" BorderStyle="Solid" Font-Names="Verdana" Width="110px"></ItemStyle>
                        ...
                        ItemStyle-Width="40px" ItemStyle-BorderStyle="Solid" 
                         ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gray">                       
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#FFCCFF" BorderColor="Gray" BorderWidth="1px" BorderStyle="Solid" Font-Names="Verdana" Font-Size="10pt" Width="50px"></ItemStyle>
                            ...
                            <asp:TemplateField  ItemStyle-Font-Names="Verdana">
                            <ItemTemplate>
                            <asp:Label ID="lblRateGr" runat="server" Width="50px" CssClass="rate" style="Text-Align:Center"   Text='<%# Eval("RATE") %>' > </asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField   >
                        <ItemTemplate>
                        <asp:TextBox ID="txtApprvLinePhoto" runat="server" Width="50px" CssClass="linePhoto" BorderStyle="None" style="Text-Align:Center" autocomplete="off" Onkeyup  ='CalculateTotals()'  BackColor="Pink" Text='<%# Eval("ANOLINEPHOT") %>' />  
                        </ItemTemplate>
                        </asp:TemplateField>
                                               

                        <%--<asp:BoundField DataField="APVAMOUNT" SortExpression="APVAMOUNT" ItemStyle-Font-Names="Verdana"
                        ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" ReadOnly="True" ItemStyle-Font-Size="10"
                        ItemStyle-Width="50px" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gray" ItemStyle-BackColor="#FFCCFF" />--%>
                        ...
                        <asp:TemplateField ItemStyle-Font-Names="Verdana" >
                            <ItemTemplate >
                                ...
                                <asp:Label ID="lblApprvAmnd" runat="server"  Width="40px" CssClass="apvAmount" style="Text-Align:Center"   BackColor="" Text='<%# Eval("APVAMOUNT") %>  '> </asp:Label>   
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText=""  ItemStyle-Width="30px" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gray">
                            <ItemTemplate> 
                                <asp:LinkButton ID="linkButtonEdit" Font-Names="Verdana"  CommandName="Select" runat="server" Text="Post" ></asp:LinkButton>
                            </ItemTemplate>
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" BorderColor="Gray" BorderWidth="1px" BorderStyle="Solid" Width="30px"></ItemStyle>
                        ...
                        <%--<asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button id="btnChecked" CssClass="Submitbutton" runat="server" Text="Checked" CommandName="btnCheck_Click" /> 
                            </ItemTemplate>
                        </asp:TemplateField>--%>

                     <asp:HyperLinkField DataNavigateUrlFields="EPLink" ItemStyle-Font-Names="Verdana" ItemStyle-Width="30px" 
                         SortExpression="EPLink" Text="E-Paper" Target="_blank" >

<ItemStyle Font-Names="Verdana" Width="50px"></ItemStyle>
                     </asp:HyperLinkField>
